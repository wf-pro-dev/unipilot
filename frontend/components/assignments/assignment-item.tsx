...
import { Calendar, Clock, MoreVertical, Edit, Trash2, Flag } from "lucide-react"
...
export function AssignmentItem({ 
  ...
  return (
    <Card 
      className={`glass border-0 hover:bg-white/5 transition-colors ${
        !disabled && onAssignmentClick ? 'cursor-pointer' : ''
      } ${disabled ? 'opacity-50' : ''}`}
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <Badge 
                  variant="outline" 
                  className={`text-xs ${priorityColors[assignment.Priority as keyof typeof priorityColors]}`}
                >
