        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 rounded-xl bg-white/5 border border-white/5">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 text-white">
                ...
                <span className="text-sm">{format(new Date(user.CreatedAt), "MMMM d, yyyy")}</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {user.CoursesCode && user.CoursesCode.length > 0 && user.CoursesCode.map((code: string) => (
                <Badge key={code} className="bg-blue-500/10 text-blue-300 border-blue-500/20 px-3 py-1.5 hover:bg-blue-500/20 transition-colors">
