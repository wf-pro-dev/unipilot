...
function BaseAssignmentCard(props: AssignmentCardProps) {
  ...
  return (
    <div
      ...
      <div className="flex-1 min-w-0 flex flex-col relative z-10 gap-1">
        
        <p className="text-body font-medium text-white truncate leading-tight">{props.assignment.Title}</p>

        <div className="text-caption text-gray-400 flex items-center">
